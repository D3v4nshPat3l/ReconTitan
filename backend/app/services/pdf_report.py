...
def build_pdf_report(data: dict[str, Any]) -> bytes:
    ...
    meta_rows = [
        ...
        ["Report version", Paragraph(_text(data.get("version", "0.4.1"), 40), styles["BodyText"])],
    ]
    ...
    story.extend([
        ...
        Spacer(1, 4 * mm),
        Paragraph(
            f"Generated by ReconTitan {_text(data.get('version', '0.4.1'), 40)}. Authorized security testing only.",
            styles["TinyMuted"],
        ),
    ])
